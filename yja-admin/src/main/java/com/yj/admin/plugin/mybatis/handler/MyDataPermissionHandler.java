package com.yj.admin.plugin.mybatis.handler;

import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.core.toolkit.StringPool;
import com.baomidou.mybatisplus.extension.plugins.handler.DataPermissionHandler;
import com.yj.admin.plugin.mybatis.annotation.DataPermission;
import com.yj.admin.util.SecurityUtils;
import com.yj.core.common.base.IBaseEnum;
import com.yj.core.common.enums.DataScopeEnum;
...
public class MyDataPermissionHandler implements DataPermissionHandler {
    ...
    public static Expression dataScopeFilter(String deptAlias, String deptIdColumnName, String userAlias, String userIdColumnName, Expression where) {
        ...
        switch (dataScopeEnum) {
            ...
            default:
                deptId = SecurityUtils.getDeptId();
                appendSqlStr = deptColumnName + " IN ( SELECT id FROM yja_dept WHERE id = " + deptId + " OR FIND_IN_SET( " + deptId + " , tree_path ) )";
                break;
        }
