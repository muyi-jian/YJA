package com.yj.admin.plugin.easyexcel;
...
import com.yj.core.common.enums.GenderEnum;
...
public class UserImportListener extends MyAnalysisEventListener<UserImportVO> {
    ...
    public UserImportListener(String deptId) {
        this.deptId = deptId;
            ...
            if (StrUtil.isNotBlank(roleCodes)) {
                roleIds = roleService.list(
                                new LambdaQueryWrapper<SysRole>()
                                        .in(SysRole::getRoleno, roleCodes.split(","))
